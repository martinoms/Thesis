...
# --- Simulation + Barfi Editor Step ---
    ...
    def create_flow_block(i):
        ...
        fb.add_option(name="flow_temp_name", type="display", value="Temperature (°C)")
        fb.add_option("flow_temp", type="input", value="80.0", label="Temperature (°C)")
        fb.add_option(name="flow_rate_name", type="display", value="Flow Rate (kg/s)")
        fb.add_option("flow_rate", type="input", value="5.0", label="Flow Rate (kg/s)")
        fb.add_option(name="flow_name_name", type="display", value="Flow Name")
